...
class Index extends React.Component {
  ...
  leerjson(){
   ...
   eliminar = value => () =>{
    ...
    if (confirm('¿Estás seguro de borrar esta pregunta?')) {
       this.enviarPost("ControladorPrincipal?accion=BorrarPreguntaAction&preguntaEliminada="+value)
    } 
  } 
  ...
  render() {
    ...
    <Paper className={classes.paper} >
        ...
        <Button variant="contained" color="primary" className={classes.button} size="large" onClick={() => this.enviarPost("ControladorPrincipal?accion=TablaExamenesAction")} >
          ...
          {this.state.preguntas.map(row => {
            return (
              <TableRow className={classes.row}>
                ...
                <CustomTableCell> 
                    <IconButton aria-label="Ver Pregunta" className={classes.margin} onClick = {() => this.enviarPost("ControladorPrincipal?accion=VerPreguntaAction&pregunta="+row)}> 
                        <Icon className={classes.icon}>visibility</Icon> 
                    </IconButton>  
                    <IconButton aria-label="Editar Pregunta" className={classes.margin} onClick = {() => this.enviarPost("ControladorPrincipal?accion=EditarPreguntaAction&pregunta="+row)}>  
                        <Icon className={classes.icon}>edit</Icon> 
                    </IconButton> 
                    <IconButton aria-label="Borrar Pregunta" className={classes.margin}  onClick = {this.eliminar(''+row).bind(this)}>  
