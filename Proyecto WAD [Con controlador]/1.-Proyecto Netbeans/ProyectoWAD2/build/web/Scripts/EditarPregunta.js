      ...
      <Paper className={classes.paper}>
        ...
        <Grid container spacing={4}>
         ...
         >
            ...
            <Button fullWidth variant="outlined" color="secondary" onClick={() => this.enviarPost("ControladorPrincipal?accion=TablaPreguntasAction")}>Regresar</Button>
        </form>
      </Paper>
      </main>
    );
